...
class CreateLineKanbanBinsTable extends Migration
{
    protected $table_name_1 = "line_kanban_bins";
    /**
     * Run the migrations.
     *
     * @return void
        ...
        */
        ...
        Schema::create($this->table_name_1, function (Blueprint $table) {
            ...
            */
            ...
            $table->string('line_kanban_bin_id_parent')->nullable()->comment('comment');//->index()
            //$table->timestamp('time_create')->nullable()->useCurrent()->default(DB::raw('CURRENT_TIMESTAMP'))->comment('comment');//->index()
            $table->double('quantity')->nullable()->default(0)->comment('comment');
